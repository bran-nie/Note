...
/** 将 Date 转为 clockTime */
function serializeClockTime(date: Date): ClockTime {
  return {
    hours: date.getHours(),
...
function civilianHours(clockTime: ClockTime): ClockTime {
  return {
    ...clockTime,
...
/** 添加 am pm 标识 */
function appendAMPM(clockTime: ClockTime): ClockTime {
  return {
    ...clockTime,
...
/** 补零 */
const doubleDigitas = (civilianTime: ClockTime) =>
  compose(
    prependZero('hours'),
    prependZero('minutes'),
    prependZero('seconds')
